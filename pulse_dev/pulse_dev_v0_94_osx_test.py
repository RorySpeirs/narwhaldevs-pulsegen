...
class NarwhalPulseGen:
    ...
    def _get_message(self, timeout=0.0, print_all_messages=False):
        ...
        print(ord(byte_message_identifier))
...
if __name__ == "__main__":
    # usb_port ='COM4'
    # usb_port = '/dev/tty.usbserial-FT3KRFFN0'
    usb_port = '/dev/tty.usbserial-FT3KRFFN1'
    # usb_port = '/dev/cu.usbserial-FT3KRFFN0'
    # usb_port = '/dev/cu.usbserial-FT3KRFFN1'
