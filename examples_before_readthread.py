...
import ndpulsegen_before_readthread as ndpulsegen
...
def trig_out_on_specific_instructions(pg):
    ...
    instr2 = ndpulsegen.transcode.encode_instruction(2,0b00001111,2,0,0, False, False, False)
    instr3 = ndpulsegen.transcode.encode_instruction(3,0b00011000,3,0,0, False, True, False)    #This one will too.
    instructions = [instr0, instr1, instr2, instr3]
    pg.write_instructions(instructions)
...
def using_loops_advanced(pg):
    #address, state, countdown, loopto_address, loops, stop_and_wait_tag, hard_trig_out_tag, notify_computer_tag
    instr0 = ndpulsegen.transcode.encode_instruction(0,0b11111111,1,2,1, False, False, True) #skip forward to 2 the first time it is executed.
    ...
    instr_a = ndpulsegen.transcode.encode_instruction(5946,0b11111111,1,0,0, False, False, True)
...
def powerline_test_global_setting(pg):
    #address, state, countdown, loopto_address, loops, stop_and_wait_tag, hard_trig_out_tag, notify_computer_tag
    instr0 = ndpulsegen.transcode.encode_instruction(0,0b11111111,100000,0,0, False, False, False)
...
def powerline_test_instruction_tag_single_run(pg):
    ...
    instr0 = ndpulsegen.transcode.encode_instruction(0,0b11111111,100000,0,0, False, False, False, False)
...
def powerline_test_instruction_tag_continuous_run(pg):
    ...
    instr0 = ndpulsegen.transcode.encode_instruction(1,0b11111111,100000,0,0, False, False, False, True)
